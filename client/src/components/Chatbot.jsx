    ...
    <>
      ...
      >
        <div className="relative">
          <div className="bg-gradient-to-r from-red-500 via-pink-500 to-purple-600 text-white p-4 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 border-2 border-white">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className={`fixed bottom-6 right-6 z-50 bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden ${
          ...
          >
            {/* Header */}
            <div className="relative bg-gradient-to-r from-red-500 via-pink-500 to-purple-600 text-white p-4">
              ...
              <div className="relative flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-bold text-lg">Life Link AI</h3>
            ...
            {!isMinimized && (
              <>
                {/* Messages */}
                <div className="flex-1 overflow-y-auto p-4 space-y-4 h-[450px] bg-gradient-to-b from-gray-50 to-white">
                  {messages.map((message) => (
                    ...
                    >
                      <div className={`flex items-start space-x-3 max-w-[85%] ${
                        ...
                        <div className={`h-9 w-9 rounded-full flex items-center justify-center shadow-md ${
                          message.type === 'user' 
                  ...
                  {isLoading && (
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        <div className="h-9 w-9 rounded-full bg-gradient-to-r from-red-500 to-pink-500 flex items-center justify-center shadow-md">
                      ...
                      <div className="flex gap-2">
                        {emergencyActions.map((action, index) => (
                          <motion.button
                            ...
                            className="flex items-center space-x-2 px-3 py-2 text-xs bg-red-50 hover:bg-red-100 text-red-700 rounded-lg transition-colors border border-red-200"
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {quickActions.map((action, index) => (
                          <motion.button
                            key={index}
                            onClick={() => sendMessage(action.text)}
                            className="flex items-center space-x-2 p-3 text-xs bg-white hover:bg-gray-50 rounded-lg transition-colors text-left border border-gray-100 shadow-sm"
                ...
                {!showSuggestions && (
                  <div className="p-2 border-t border-gray-100 bg-gray-50">
                    <motion.button
                      ...
                      className="w-full flex items-center justify-center space-x-2 py-2 text-xs text-gray-600 hover:text-gray-800 transition-colors"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="flex-1 relative">
                      <input
                        ...
                        className="w-full px-4 py-3 pr-12 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white"
                        disabled={isLoading}
                      />
                      {inputMessage && (
                        <motion.button
                    ...
                    <motion.button
                      ...
                      className="p-3 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-2xl hover:from-red-600 hover:to-pink-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-xl"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
                      {isLoading ? (
